...
namespace ImGui
{
    ...
    IMGUI_API void          Keybind(const char* label, int* key, int* mode, bool label_active);
    ...
    IMGUI_API bool BeginCombo(const char* label, const char* preview_value, float val, bool multi = false, ImGuiComboFlags flags = 0);
    ...
    IMGUI_API ImDrawList*   GetBackgroundd1awList();                                            // this draw list will be the first rendered one. Useful to quickly draw shapes/text behind dear imgui contents.
    IMGUI_API ImDrawList*   GetForegroundd1awList();                                            // this draw list will be the last rendered one. Useful to quickly draw shapes/text over dear imgui contents.
...
struct ImDrawList
{
    ...
    IMGUI_API void  Addd1awCmd();                                               // This is useful if you need to forcefully create a new draw call (to allow for dependent rendering / blending). Otherwise primitives are merged into the same draw-call as much as possible
    ...
    IMGUI_API void  _PopUnusedd1awCmd();
...
namespace ImGui
{
    ...
    //static inline ImDrawList* GetOverlayDrawList()            { return GetForegroundd1awList(); }                                 // OBSOLETED in 1.69 (from Mar 2019)
