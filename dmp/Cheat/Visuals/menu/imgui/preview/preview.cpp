...
//		draw->AddText(pos + ImVec2(1, 3), ImColor(vars::visible::box_color), "Dual Elites");
//	}
//
//	if (cond == RIGHT_COND) {
//		size = ImVec2(ImTextSize.x + 10, ImTextSize.y + 6);
//		draw->AddText(pos + ImVec2(9, 3), ImColor(vars::visible::box_color), "Dual Elites");
//	}
//
//	if (cond == TOP_COND || cond == BOT_COND) {
//		size = ImVec2(110, ImTextSize.y + 6);
//		draw->AddText(pos + ImVec2(55 - ImGui::CalcTextSize("Dual Elites").x / 2, 3), ImColor(vars::visible::box_color), "Dual Elites");
//	}
//
//	if (cond == IN_MOVE_COND || cond == POOL_COND) {
//		size = ImVec2(55, 20);
