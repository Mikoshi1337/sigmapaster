...
inline float accent_color[] = { 23, 124, 255 };
/*
/*
...
namespace ImGui
{
    ...
    IMGUI_API bool          Checkbox(const char* label, bool* v, bool settings_menu = false);
...
enum ImGuiColorEditFlags_
{
    ...
    ImGuiColorEditFlags_Pallet          = 1 <<29,
...
struct ImDrawList
{
    ...
    IMGUI_API void  AddRectFilledMultiColorRounded(const ImVec2& p_min, const ImVec2& p_max, ImU32 bg_color, ImU32 col_upr_left, ImU32 col_upr_right, ImU32 col_bot_right, ImU32 col_bot_left, float rounding = 0.0f, ImDrawFlags rounding_corners = NULL);
