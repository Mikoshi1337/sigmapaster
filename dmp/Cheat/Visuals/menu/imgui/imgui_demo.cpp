...
//            if (ImGui::IsItemActive())
//                ImGui::GetForegroundd1awList()->AddLine(io.MouseClickedPos[0], io.MousePos, ImGui::GetColorU32(ImGuiCol_Button), 4.0f); // Draw a line between the button and the mouse cursor
//
...
//            if (draw_bg)
//                ImGui::GetBackgroundd1awList()->AddCircle(window_center, window_size.x * 0.6f, IM_COL32(255, 0, 0, 200), 0, 10 + 4);
//            if (draw_fg)
//                ImGui::GetForegroundd1awList()->AddCircle(window_center, window_size.y * 0.6f, IM_COL32(0, 255, 0, 200), 0, 10);
//            ImGui::EndTabItem();
//        }
//
//        ImGui::EndTabBar();
